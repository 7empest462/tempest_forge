                        ...
                        .show(ui, |ui| {
                            ...
                            for (block_type, count) in items {
                                ...
                                let (name, color) = match block_type {
                                    BlockType::Wood => {
                                        ("Wood", egui::Color32::from_rgb(139, 69, 19))
                                    }
                                    BlockType::Stone => ("Stone", egui::Color32::GRAY),
                                    BlockType::IronOre => {
                                        ("Iron Ore", egui::Color32::from_rgb(180, 160, 150))
                                    }
                                    BlockType::GoldOre => {
                                        ("Gold Ore", egui::Color32::from_rgb(255, 215, 0))
                                    }
                                    BlockType::CraftString => {
                                        ("String", egui::Color32::from_rgb(220, 220, 200))
                                    }
                                    BlockType::Gear => {
                                        ("Gear", egui::Color32::from_rgb(150, 150, 180))
                                    }
                                    BlockType::Axle => {
                                        ("Axle", egui::Color32::from_rgb(140, 140, 140))
                                    }
            ...
            egui::ScrollArea::vertical().show(ui, |ui| {
                ...
                draw_manual_collapsing(ui, ctx, mouse_pos, "⛏ Tiered Tools", |ui| {
                    ...
                    draw_tier_row(
                        ...
                        |inv| inv.has_iron_pickaxe,
                        |inv| inv.has_iron_pickaxe = true,
                        mouse_pos,
                        ctx,
                    );
                    ...
                    draw_tier_row(
                        ...
                        |inv| inv.has_gold_pickaxe,
                        |inv| inv.has_gold_pickaxe = true,
                        mouse_pos,
                        ctx,
                    );
                    ...
                    draw_tier_row(
                        ...
                        "2x Wood speed",
                        &[(BlockType::IronOre, 4)],
                        |inv| inv.has_iron_axe,
                        |inv| inv.has_iron_axe = true,
                        mouse_pos,
                        ctx,
                    );
                });
                ...
                draw_manual_collapsing(ui, ctx, mouse_pos, "⚔ Combat Equipment", |ui| {
                    ...
                    draw_tier_row(
                        ...
                        |inv| inv.has_gold_sword,
                        |inv| inv.has_gold_sword = true,
                        mouse_pos,
                        ctx,
                    );
                ...
                draw_manual_collapsing(ui, ctx, mouse_pos, "🦾 Mech Upgrades", |ui| {
                    ...
                    draw_tier_row(
                        ...
                        |inv| inv.armor_tier = ArmorTier::Iron,
                        mouse_pos,
                        ctx,
                    );
                    ...
                    draw_tier_row(
                        ...
                        |inv| inv.armor_tier = ArmorTier::Gold,
                        mouse_pos,
                        ctx,
                    );
                });
                ...
                draw_manual_collapsing(ui, ctx, mouse_pos, "⛵ Maritime", |ui| {
                    ...
                    draw_tier_row(
                        ...
                        |inv| {
                            *inv.resources.entry(BlockType::Boat).or_insert(0) += 1;
                        },
                        mouse_pos,
                        ctx,
                    );
                ...
                draw_manual_collapsing(
                    ...
                    |ui| {
                        ui.add_space(5.0);
                        egui::Grid::new("block_selector_grid")
                            .spacing([10.0, 10.0])
                            .show(ui, |ui| {
                                let blocks = [
                                    (
                                    ...
                                    (
                                        BlockType::Brick,
                                        "Brick",
                                        Color::from(bevy::color::palettes::css::ORANGE_RED),
                                    ),
                                    (
                                        BlockType::Concrete,
                                        "Concrete",
                                    ...
                                    (
                                        BlockType::IronBlock,
                                        "Iron",
                                        Color::from(bevy::color::palettes::css::SILVER),
                                    ),
                                    (
                                        BlockType::WoodPlanks,
                                        "Wood",
                                        Color::from(bevy::color::palettes::css::BROWN),
                                    ),
                                    (
                                        BlockType::Glass,
                                        "Glass",
                                        Color::from(bevy::color::palettes::css::LIGHT_BLUE),
                                    ),
                                    (
                                        BlockType::Slope,
                                        "Slope",
                                    ...
                                    (
                                        BlockType::Door,
                                        "Door",
                                        Color::from(bevy::color::palettes::css::SANDY_BROWN),
                                    ),
                                    (
                                    ...
                                    (
                                        ...
                                        "Procedural Wall",
                                        Color::from(bevy::color::palettes::css::GOLD),
                                    ),
                                ];
                ...
                draw_manual_collapsing(ui, ctx, mouse_pos, "⚙ Industrial Machinery", |ui| {
                    ui.add_space(5.0);
                    egui::Grid::new("machinery_selector_grid")
                        .spacing([10.0, 10.0])
                        .show(ui, |ui| {
                            let machines = [
    ...
    ui.group(|ui| {
        ui.horizontal(|ui| {
            ui.vertical(|ui| {
                ...
                ui.add(
                    egui::Label::new(egui::RichText::new(desc).size(10.0))
...
fn draw_manual_collapsing(
    ...
    let _header_res = ui.horizontal(|ui| {
        ...
        let btn =
            ui.add(egui::Button::new(egui::RichText::new(text).strong().size(16.0)).frame(false));
